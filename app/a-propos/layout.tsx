...
export const metadata: Metadata = {
  title: "À propos | Aurélien Duberville - Webmaster & Formateur",
  ...
  keywords: ["Aurélien Duberville", "Webmaster", "Formateur", "Développeur web", "Éco-conception", "Chef de projet", "Orange"],
};
